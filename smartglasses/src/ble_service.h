...
// ---- Phase 6 evidence helpers ----------------------------------------------

/// Milliseconds since BLE service initialization.
uint32_t ble_service_uptime_ms();

/// Number of successful BLE connects observed since init.
uint32_t ble_service_connect_count();

/// Number of BLE disconnects observed since init.
uint32_t ble_service_disconnect_count();

/// millis() timestamp captured at the last successful BLE connect.
uint32_t ble_service_last_connect_ms();

/// millis() timestamp captured at the last BLE disconnect.
