...
#define FIRMWARE_VERSION_STRING "3.1.0"
...
// =============================================================================
// BLE CONFIGURATION - Optimized for fast photo transfer
// =============================================================================
#define BLE_MTU_SIZE 517            // Maximum MTU for efficiency
#define BLE_CHUNK_SIZE 500          // Large chunks for fast transfer (MTU 517 - overhead)
#define BLE_PHOTO_TRANSFER_DELAY 10 // 10ms delay for fast transfer
...
// Burst memory guardrails (PSRAM)
#define BURST_MEMORY_RESERVE_BYTES (128 * 1024) // Keep headroom for BLE/app buffers
#define BURST_FRAME_ESTIMATE_BYTES (48 * 1024)  // Conservative JPEG/frame estimate at VGA
#define BURST_MEMORY_BUDGET_PERCENT 65          // Max percent of available PSRAM for burst buffers
...
// =============================================================================
// BLE UUID DEFINITIONS - Generic Camera Service
// =============================================================================
// Using standard Nordic UART Service (NUS) base UUID format for compatibility
// with generic BLE apps like nRF Connect, LightBlue, BLE Scanner, etc.
//
// Photo Service: Custom service for camera control and image transfer
// - Photo Data: Subscribe to notifications to receive JPEG image chunks
// - Photo Control: Write commands to control camera
//   Commands: 0x01 = Take single photo, 0x00 = Stop, 0x02 = Start interval capture
//            0x04 = Burst capture, 0x05 = Burst cadence hint payload
//
#define CAMERA_SERVICE_UUID "12345678-1234-5678-1234-56789abcdef0"
#define PHOTO_DATA_UUID "12345678-1234-5678-1234-56789abcdef1"
#define PHOTO_CONTROL_UUID "12345678-1234-5678-1234-56789abcdef2"
...
#define POWER_OFF_PRESS_MS 2000     // Long press duration for deep-sleep power off
