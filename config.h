...
#define BURST_DEFAULT_COUNT 3       // Default number of frames in a burst
#define BURST_MAX_COUNT 5           // Maximum burst frame count
#define BURST_INTER_CAPTURE_DELAY 500 // Delay between burst captures (ms) - 500ms for motion tracking
...
//            0x04 = Burst capture (3 frames for motion detection)
//
